...
int vip,ekonomi,harga,hari,total,bayar,kembali;
    ...
    private void initComponents() {
        ...
        pelayanan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pilih", "Paket Anti Kutu", "Paket Anti Jamur", "Paket Kombinasi", "Paket Maintenance" }));
        ...
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 17, -1, -1));

        jLabel7.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel7.setText("Nama Kucing");
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(361, 51, -1, -1));
        ...
        jPanel3.add(txtpemilik, new org.netbeans.lib.awtextra.AbsoluteConstraints(494, 21, 250, -1));

        txtkucing.setBackground(new java.awt.Color(255, 204, 204));
        jPanel3.add(txtkucing, new org.netbeans.lib.awtextra.AbsoluteConstraints(494, 52, 250, -1));
        ...
        jPanel3.add(btncetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 330, -1, -1));
        ...
        jPanel3.add(btnkeluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 330, -1, -1));
    ...
    private void pelayananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pelayananActionPerformed
        ...
        else if(pelayanan.getSelectedItem().equals("Paket Anti Kutu")){
            vip=180000;
            ekonomi=90000;
        }
        else if(pelayanan.getSelectedItem().equals("Paket Anti Jamur")){
            vip=150000;
            ekonomi=75000;
        }
        else if(pelayanan.getSelectedItem().equals("Paket Kombinasi")){
            vip=260000;
            ekonomi=130000;
        }
        else if(pelayanan.getSelectedItem().equals("Paket Maintenance")){
            vip=300000;
            ekonomi=150000;
        }
